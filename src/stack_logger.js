...
export default class StackLogger {
    ...
    constructor(opts) {
        ...
        this.#store.indentSize =
            opts.indentSize && typeof opts.indentSize === 'number' ? opts.indentSize : 2;
    ...
    tick(indent, indentSize) {
        return this.extend({
            indent:
                this.#store.indent + (typeof indent === 'number' ? indent : this.#store.indentSize),
    ...
    getText(indent, msgs) {
        ...
        msgs = indent
            ? [
                  this.#store.indentor
                      .repeat(indent)
                      .concat(util.formatWithOptions({ color: true }, msgs[0])),
                  ...msgs.slice(1),
              ]
            : msgs;
