...
function prepCli(packageJson) {
  ...
  program
    ...
    .arguments('[port]')
    .description('Launch musiquedl server on an HTTP interface (unimplemented)', {
  ...
  */
  ...
  program
    ...
    .on('--help', () => {
      console.log('');
      console.log('Info:');
      console.log('  See `musiquedl help filter` for more information on constructing filter PATTERNs');
      console.log('');
      console.log('  Optionally, args and options provided after `--` are passed as options to the musiquedl download interface');
      ...
      console.log('  $ musiquedl search -- -d ~/Music');
      console.log('');
      console.log('  # search non-interactively and download afterwards');
      console.log("  $ musiquedl search --query 'billie eilish @ type=album, title=*was older, duration=3s.., explicit=false'");
      console.log('');
      console.log('  # search interactively, save a maximum of 5 results to file and download later');
      console.log('  $ musiquedl search -n 5 -o queue.txt');
      console.log('  $ musiquedl -i queue.txt');
    });
  */
  ...
  const config = program
    ...
    .on('--help', () => {
      console.log('');
      console.log('Examples:');
      console.log('  $ musiquedl profile new test');
      ...
      console.log('  $ musiquedl --profile test deezer:playlist:1963962142');
      console.log('    ? Enter an encryption key: **********');
      console.log('  [...]');
    });
  */
